...
<table>
    <thead>
   	...
   	<tbody>
        <c:forEach items="${listaAstronauti}" var="current">
        		<tr>
...
<br><br>
<h2>Tabella Astronauti - Missioni</h2><br>
<table>
    <thead>
        <tr>
        	<th>Nome Astronauta</th>
        	<th>Cognome Astronauta</th>
        	<th>Nome Missione</th>
